...
import com.simplicia.browserfactory.BrowserManagerFactory;
import com.simplicia.browserfactory.DriverManager;
...
public class BaseTest {
	...
	public void setUp() throws Exception {
		...
		driverManager = BrowserManagerFactory.getBrowser(properties.getProperty(GlobalConstants.BROWSER));
		driver = driverManager.getDriver();

		wait = new WebDriverWait(driver, timeOut);
		menuNavigate = new MenuNavigation(driver, properties);
